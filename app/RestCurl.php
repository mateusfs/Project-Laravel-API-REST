...
Class RestCurl {
    ...
    private static $header = array('Accept: application/json', 'Content-Type: application/json');

    public static function setHeaders($header) {
        RestCurl::$header = array('Accept: application/json', 'Content-Type: application/json');
        array_push(RestCurl::$header, $header);
    }
    ...
    public static function exec($method, $url, $obj = array()) {
        ...
        curl_setopt($curl, CURLOPT_HTTPHEADER, RestCurl::$header);
